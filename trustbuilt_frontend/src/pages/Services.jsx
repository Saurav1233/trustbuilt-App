...
const servicesData = [
  ...
  {
    id: 9,
    tab: 'Skill Based Courses',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5" />
      </svg>
    ),
    headline: 'Learn industry-ready skills that get you hired',
    tagline: 'Practical, hands-on courses taught by industry professionals.',
    description: 'Trust Built offers skill-based training programs designed to prepare students and professionals for real-world careers in media, marketing, and communication. Our courses are hands-on, industry-aligned, and taught by practitioners — not just teachers. Whether you\'re a fresher or looking to upskill, we have the right program for you.',
    process: [
    ...
    courses: [
      ...
      { name: 'Front Office',                icon: '🏢' },
      { name: 'Field Marketing',             icon: '📣' },
      { name: 'Public Relations',            icon: '📰' },
      { name: 'Brand Management',            icon: '💎' },
      { name: 'Social Media Managing',       icon: '📱' },
      { name: 'Anchoring & Content Writing', icon: '🎙️' },
            ...
            <motion.div key={active}
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-dark-500">
                  ...
                  {/* Courses grid for Skill Based Courses */}
                  {service.courses && (
                    <div className="mt-8">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {service.courses.map((course, i) => (
                          <div key={i}
                            className="bg-dark-800 border border-dark-500 rounded-xl px-3 py-3
                                       flex items-center gap-2 hover:border-gold-500/40
                                       hover:bg-gold-500/5 transition-all duration-200">
