...
from .serializers_jwt import EmailTokenObtainPairView
from . import views
...
urlpatterns = [
    ...
    # ── NEW: Admin — Consultations ────────────────────────────────────────
    path('admin/consultations/',          views.AdminConsultationsView.as_view(), name='admin-consultations'),
    path('admin/consultations/<int:pk>/', views.AdminConsultationsView.as_view(), name='admin-consultation-update'),
]